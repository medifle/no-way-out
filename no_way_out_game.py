...
class NoWayOutGame:
    ...
    def __init__(self, current_room=None, inventory=None):
        ...
        self.room_map = {
            ...
            "attic": Room(name="attic", description="I am in attic.", connect=["stairs room"], entry_requirement=None, items=[self.all_items['stairs room key'], self.all_items['mask']]),
